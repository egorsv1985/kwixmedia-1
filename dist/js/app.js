(() => {
  ...
  const y = {
    ...
    is: function (e) {
      ...
      if ("string" == typeof e) {
        ...
        for (r = w(e), n = 0; n < r.length; n += 1) if (r[n] === i) return !0;
        return !1;
      }
      if (e === s) return i === s;
      if (e === t) return i === t;
          ...
          void 0 !== n &&
            ...
            (L(e[r]) && L(i[r])
              ? i[r].__swiper__
                ...
                : M(e[r], i[r])
              : !L(e[r]) && L(i[r])
              ? ((e[r] = {}), i[r].__swiper__ ? (e[r] = i[r]) : M(e[r], i[r]))
              : (e[r] = i[r]));
        }
      }
    }
  ...
  const W = {
    ...
    updateSlides: function () {
      ...
      for (let r = 0; r < p; r += 1) {
        ...
        const a = c.eq(r);
        if (
          (x && e.grid.updateSlide(r, a, p, t), "none" !== a.css("display"))
        ) {
      ...
      if (
        ...
        if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!n.support.smoothScroll)
            return (
              k({ swiper: n, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e, t, s, i, r) {
      ...
      if (o.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!n.support.smoothScroll)
            return (
              k({ swiper: n, targetPosition: s, side: e ? "left" : "top" }), !0
            );
      ...
      if (
        ...
        const s = t.slides
          ...
          i = t.slides
            ...
            .eq(0)
            .index();
        r = void 0 === s ? i : void 0 === i ? s : i - e < e - s ? i : s;
      }
      t.slideTo(r);
    }
    function o() {
  ...
  window.addEventListener("load", function (e) {
    !(function () {
      if ((de(), document.querySelector(".product-card__slider"))) {
        const e = new oe(".thumbnail__slider", {
          modules: [le],
          observer: !0,
          observeParents: !0,
          slidesPerView: 2,
